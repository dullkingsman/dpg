...
case "$OS" in
  ...
  *)      die "Unsupported OS: $OS (Windows: see https://thec1oud.github.io/dpg/docs/getting-started/installation/)" ;;
esac
...
if [[ "$PLATFORM" == "linux" ]]; then
  ...
  else die "Unsupported Linux distribution. Install dependencies manually — see https://thec1oud.github.io/dpg/docs/getting-started/installation/"
  fi
fi
