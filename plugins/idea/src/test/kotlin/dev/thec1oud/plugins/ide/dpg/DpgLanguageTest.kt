...
import dev.thec1oud.plugins.ide.dpg.lang.DpgParserDefinition
...
class DpgLanguageTest : BasePlatformTestCase() {
    ...
    fun testCommentTokens() {
        ...
        assertTrue(comments.contains(dev.thec1oud.plugins.ide.dpg.lang.DpgTokenTypes.LINE_COMMENT))
        assertTrue(comments.contains(dev.thec1oud.plugins.ide.dpg.lang.DpgTokenTypes.BLOCK_COMMENT))
    }
}
