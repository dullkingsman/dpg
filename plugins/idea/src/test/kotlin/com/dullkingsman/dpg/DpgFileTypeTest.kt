...
class DpgFileTypeTest : BasePlatformTestCase() {
    ...
    fun testName() = assertEquals("DPG", DpgFileType.INSTANCE.name)

    fun testDefaultExtension() = assertEquals("dpg", DpgFileType.INSTANCE.defaultExtension)
    ...
    fun testLanguage() = assertSame(DpgLanguage, DpgFileType.INSTANCE.language)

    fun testIcon() = assertNotNull(DpgFileType.INSTANCE.icon)

    fun testSingleton() = assertSame(DpgFileType.INSTANCE, DpgFileType.INSTANCE)
