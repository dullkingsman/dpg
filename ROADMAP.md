...
- [x] Format-on-save integration guide for editors ([editor integration](https://thec1oud.github.io/dpg/docs/getting-started/editor-integration/)) — VS Code (Run on Save), Neovim (autocmd), Helix (formatter wrapper), JetBrains (File Watchers), CI gate (`--check`)
...
- [x] Shell completion (Bash, Zsh, Fish, PowerShell) via Cobra — `dpg completion <shell>`; documented in the [CLI reference](https://thec1oud.github.io/dpg/docs/reference/commands/)
